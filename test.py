...
NS_dict = {'a':1,'mu':0.2,'alpha_R':2, 'Delta_0':0.2,'Delta_c':0.2,'epsilon':1,'wireLength':300, 'mu_lead':25.0, 'Nbarrier':2,'Ebarrier':10.0, 'gamma':0.000, 'QD':'no', 'VD':0.8, 'dotLength':20, 'SE':'no', 'Vz':0.0, 'voltage':0.0,'varymu':'no', 'lamd':0,'singleband':'no'};
